...
<div class="container">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('mname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mname" type="text" class="form-control" name="mname" value="{{ old('name') }}">
    ...
    <label class="control-label col-sm-4">User Type</label>
      ...
      <select class="form-control" name="usertypeid">
            ...
            @foreach($usertype as $user)
                @if(Auth::user()->usertypeid < $user->id)
                    <option value="{{ $user->id }}">{{ $user->usertype }}</option>
                @endif
            @endforeach
    ...
    <div class="form-group{{ $errors->has('pincode') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pincode" type="number" class="form-control" name="pincode" value="{{ old('name') }}" required autofocus>
